...
# by Vishnu Bhagwat, submitted for Internshala Python Training
...
# importing evaluate window dialogbox
from evaluateteam import Ui_evaluate_team as Eva

import sqlite3
# connecting to database file(fandatabase.db)
fant = sqlite3.connect('fantasy.db')
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.BAT.setStyleSheet("color: rgb(20, 200, 175);")
        ...
        self.WK.setStyleSheet("color: rgb(20, 200, 175);")
        ...
        self.frame_2.setStyleSheet("font: 75 10pt \"Arial\";\n"
        ...
        self.points_available.setStyleSheet("color: rgb(20, 200, 175);")
        ...
        self.points_used.setStyleSheet("color: rgb(20, 200, 175);")
        self.points_used.setObjectName("points_used")
        self.horizontalLayout.addWidget(
            self.points_used, 0, QtCore.Qt.AlignHCenter)
        self.verticalLayout_3.addWidget(self.frame_2)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        spacerItem1 = QtWidgets.QSpacerItem(
            13, 345, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        ...
        self.frame_5.setStyleSheet("font: 75 10pt \"Arial\";")
        ...
        self.team_name.setStyleSheet("color: rgb(20, 200, 175);")
        ...
        self.menuManage_Teams.setStyleSheet("color: rgb(20, 200, 175);")
        self.menuManage_Teams.setStyleSheet(
            "background-color: rgb(232, 232, 232);")
        self.menuManage_Teams.setStyleSheet(
            "selection-background-color: rgb(20, 200, 175);\n""\n""")
    ...
    def file_save(self):
        if not self.error():  # IF THERE IS AN ERROR
            ...
            try:
                ...
                x = fantcurs.fetchall()
                for i in x:
                    # CHECKING IF THE TEAMNAME ALREADY EXISTS
   ...
   # ON RADIOBUTTONS CLICKED
    ...
    def openteam(self):  # upon open team selected
        ...
        self.enablebuttons()
        fantcurs.execute(
            "SELECT players from teams WHERE name= '" + teamname + "';")
        x = fantcurs.fetchall()
        score = []
        for i in x:
            fantcurs.execute(
                "SELECT value from stats WHERE player='"+i[0]+"';")
            y = fantcurs.fetchone()
            score.append(y[0])
        # print(score)
        sum = 0
